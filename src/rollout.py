...
class TrajectorySegment:
    obs: jax.Array  # (M, N, obs_dim)
    rewards: jax.Array  # (M, N)
    dones: jax.Array  # (M, N)
...
def compute_gae(
    ...
    # TODO: explain what is happening here (jax.scan)
    scan_inputs = (segment.rewards[::-1], segment.dones[::-1], segment.values[::-1])
