...
* **Solution**: Implemented a **gymnasium wrapper** that uses `info` dictionary to do **reward shaping**
    * Babisits the agents to incentivize actions that increase the probability of delivery
* Early reward hacking is transient
    * The agent pair evnetually learns that delivering soups maximizes total reward.
